                    ...
                    <Menu active-name="1-2" theme="light"  width="auto" :open-names="['1']" :class="menuitemClasses">
                      ...
                      <Submenu v-for="(menu, key) in menuLists" :key="key" :name="menu.sort" :id="menu.id">
                        <template slot="title">
                          ...
                          <MenuItem v-if="!menu.children.length" :name="menu.sort+'-'+menu.sort" :id="menu.id">{{menu.text}}</MenuItem>
                          <Submenu v-else  v-for="(cmenu, ckey) in menu" :name="menu.sort+'-'+cmenu.sort" :id="cmenu.id">
