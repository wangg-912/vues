          ...
          <template slot="title">
            ...
            <template>
              <div v-for="cmenu in menu.children">
                  <Submenu v-if="menu.children.length" :id="cmenu.id" :name = "cmenu.sort">
                  <template slot="title">
                  ...
                  <template>
                    <div v-for="(smenu, si) in cmenu.children" :key="si">
                      <MenuItem :id="cmenu.id" :name = "cmenu.sort">
                    <Icon :type="cmenu.iconCls" />
                    {{cmenu.text}}
                </MenuItem>
                    </div>
                  </template>
                <!-- <Submenu  v-if="cmenu.children.length"  :id="smenu.id" :name = "smenu.sort">
                      <template slot="title">
